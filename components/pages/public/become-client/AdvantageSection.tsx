...
const advantages = [
    ...
    },
    {
        ...
        description: "Prin această aplicație, utilizatorii au acces la toate datele disponibile despre serviciile pe care le oferiți, precum prețul, disponibilitatea, locația și alte informații relevante. Aplicația îți permite, de asemenea, să creezi și să promovezi oferte speciale. De exemplu în zilele care sunt în general rezervate, dar ulterior din diferite motive au fost anulate, se poate crea o reducere celor ce rezervă acea dată. Astfel, utilizatorii vor fi bine informați și la curent cu toate modificările. În viitor, această secțiune de reducere o să poată fi și promovată pe pagină, la loc vizibil, pentru a urgenta ocuparea datelor care sunt disponibile și doriți să vă fie rezervate.",
        eventity: true,
        competitors: false,
    },
];
